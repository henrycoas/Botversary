...
from botversary import models
from botversary import db_util
from botversary import telegram_helper
...
parser = argparse.ArgumentParser(
    ...
    description=(
        "CLI for the botversary bot. To execute, simply run the program. "
